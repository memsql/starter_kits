- dashboard: campaign_performance_lookup
  ...
  - title: Total Clicks
    ...
    explore: events
    type: single_value
    fields: [events.total_clicks, events.click_rate]
    limit: 500
  ...
  - title: Total Impressions
    ...
    explore: events
    type: single_value
    fields: [events.total_impressions]
    limit: 500
    query_timezone: America/Los_Angeles
    custom_color_enabled: true
    custom_color: "#88a7a9"
  ...
  - title: Clicks by Date
    ...
    explore: events
    type: looker_area
    fields: [events.created_date, events.click_rate, events.total_clicks]
    fill_fields: [events.created_date]
    filters:
      campaigns.advertising_channel: "-NULL"
    sorts: [events.created_date]
    limit: 500
    column_limit: 50
    stacking: ''
    show_value_labels: false
    ...
    y_axes: [{label: !!null '', maxValue: 0.5, minValue: !!null '', orientation: left,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: events.click_rate,
            name: Click Through Rate (CTR), axisId: events.click_rate}]}, {label: !!null '',
        orientation: right, series: [{id: events.total_clicks, name: Total Clicks,
            axisId: events.total_clicks}], showLabels: true, showValues: false,
  ...
  - title: Top Performing Keywords
    ...
    explore: events
    type: table
    fields: [keywords.criterion_name, events.total_clicks, events.total_impressions,
      events.click_rate, events.total_cost, session_purchase_facts.revenue]
    filters:
      keywords.criterion_name: "-NULL"
    sorts: [session_purchase_facts.revenue desc]
    limit: 100
    column_limit: 50
    dynamic_fields: [{table_calculation: profit, label: Profit, expression: "${session_purchase_facts.revenue}-${events.total_cost}",
    ...
    conditional_formatting: [{type: low to high, value: !!null '', background_color: !!null '',
        ...
        bold: false, italic: false, strikethrough: false, fields: [events.total_cost]},
      {type: low to high, value: !!null '', background_color: !!null '', font_color: !!null '',
        ...
        strikethrough: false, fields: [events.click_rate]}]
    hidden_fields: []
    y_axes: []
    listen:
      Campaign Name: campaigns.campaign_name
  ...
  - title: Keyword Spend vs Revenue
    ...
    explore: events
    type: looker_scatter
    fields: [keywords.keyword_id, session_purchase_facts.revenue, events.total_cost]
    filters:
      campaigns.campaign_id: NOT NULL
      events.traffic_source: Adwords
    sorts: [events.total_cost desc]
    limit: 500
    column_limit: 50
    stacking: ''
    show_value_labels: false
  ...
  - title: Keyword Profitability
    ...
    explore: events
    type: looker_column
    fields: [keywords.criterion_name, events.total_cost, session_purchase_facts.revenue]
    filters:
      keywords.criterion_name: "-NULL"
      events.total_cost: ">0"
    sorts: [events.total_cost desc]
    ...
    y_axes: [{label: '', maxValue: !!null '', minValue: !!null '', orientation: left,
        ...
        type: linear, unpinAxis: false, valueFormat: !!null '', series: [{id: events.total_cost_clicks,
            name: Cost, axisId: events.total_cost_clicks}, {id: session_purchase_facts.total_attribution,
            name: Attribution, axisId: session_purchase_facts.total_attribution}]}]
    series_types:
      events.total_cost_clicks: line
      session_purchase_facts.total_attribution: line
    series_labels:
      events.total_cost_clicks: Cost
      session_purchase_facts.total_attribution: Attribution
      events.total_cost: Total Spend
    hidden_series: []
  ...
  - title: CTR By Time of Day
    ...
    explore: events
    type: table
    fields: [events.click_rate, events.created_hour_of_day, events.created_day_of_week]
    pivots: [events.created_day_of_week]
    filters:
      events.created_day_of_week: ''
      events.created_hour_of_day: NOT NULL
    sorts: [events.created_day_of_week 0, events.created_hour_of_day]
    limit: 500
    column_limit: 50
    show_view_names: false
    show_row_numbers: true
    ...
    conditional_formatting: [{type: low to high, value: !!null '', background_color: !!null '',
        font_color: !!null '', palette: {name: Custom, colors: ["#FFFFFF", "#87d79b"]},
        bold: false, italic: false, strikethrough: false, fields: [events.click_rate]}]
    hidden_fields: []
    y_axes: []
    listen:
      Campaign Name: campaigns.campaign_name
  ...
  - title: Spend Benchmark
    ...
    explore: events
    type: looker_line
    fields: [sessions.weeks_since_campaing_start, campaigns.count, events.total_cost,
    ...
    limit: 500
    column_limit: 50
    dynamic_fields: [{table_calculation: campaign_spend, label: Campaign Spend, expression: "${events.total_cost}/${campaigns.count}",
        value_format: !!null '', value_format_name: !!null '', _kind_hint: measure,
        _type_hint: number}, {table_calculation: rolling_spend, label: Rolling Spend,
        expression: 'if(is_null(${events.total_cost}),null,running_total(${events.total_cost}/${campaigns.count}))',
        value_format: !!null '', value_format_name: usd_0, _kind_hint: measure, _type_hint: number}]
    stacking: ''
    show_value_labels: false
    label_density: 25
